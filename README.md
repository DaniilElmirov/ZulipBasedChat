...
---
## 10. Домашнее задание по лекции "Введение в тестирование"

### Выполнено:
- Настроено окружение для тестов.
  - Используются ActivityScenario и FragmentScenario.
  - Тесты запускаются для тестируемого экрана.
  - Настроены переиспользуемые правила UI тестов.
  - Отключены анимации при прогоне UI тестов.
- Функционал экрана чата покрыт тестами.
  - UI Happy-path и UI Integration написаны согласно примерам чек-листов.
  - Написаны UI тесты для базовой проверки отображения элементов.
  - Написаны Unit тесты на Reducer, Actor, Repository.
